...
const SportBanner = () => {
    return (
        <div className="h-[35vh] w-[80vw] bg-black my-10 rounded-2xl overflow-hidden relative shadow-[0_0_2px_1px_] shadow-[#727272] ">
            <img src={FootballImg} alt="Football" className='w-full'/>
            <span className='w-[80vw] h-[120vh] bg-black/30 backdrop-blur-md absolute z-10 top-0 -left-96 rotate-45'>s</span>
            <span className='text-white text-6xl absolute top-[50%] -translate-y-[50%] left-14 z-20'>Football</span>
        </div>
    )
}
